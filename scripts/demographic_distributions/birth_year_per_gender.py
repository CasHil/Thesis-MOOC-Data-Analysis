...
def plot_birth_year_distribution_for_all_courses(course_df: pd.DataFrame) -> None:
    ...
    sns.histplot(male_population, x="Birth year", binwidth=1,
                 alpha=1.0, label='Male', palette=palette)
    sns.histplot(female_population, x="Birth year", binwidth=1,
                 alpha=0.8, label='Female', palette=palette)
    sns.histplot(unknown_population, x="Birth year", binwidth=1,
                 alpha=0.5, label='Prefer not to say / Unknown', palette=palette)
    sns.histplot(other_population, x="Birth year", binwidth=1,
                 alpha=1.0, label='Other', palette=palette)
