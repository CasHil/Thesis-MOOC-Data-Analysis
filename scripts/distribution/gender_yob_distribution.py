...
sns.histplot(female_population, x="Birth year", binwidth=1, alpha=0.9, label='Female', palette=palette)
sns.histplot(unknown_population, x="Birth year", binwidth=1, alpha=0.7, label='Prefer not to say / Unknown', palette=palette)
sns.histplot(other_population, x="Birth year", binwidth=1, alpha=0.5, label='Other', palette=palette)
